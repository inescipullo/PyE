...
\end{center}
  ...
  \begin{center}
    ...
    para que tome la variable, se procede a agrupar las categor\'ias de la variable en intervalos de un kil\'ometro. 
    ...
    \begin{myenv}{1}
      ...
      \begin{itemize}
        ...
        \item El primer cuartil toma el valor de 1.0060 km, mentras que el segundo cuartil (o mediana)
        toma el valor de 1.6130 km y el tercer cuartil, de 3.0390 km.
        \item Se cuenta con un rango intercuartil de 2.0330 km. 
        \item El valor m\'aximo que toma la variable es de 10.9460 km y el m\'inimo es de 0 km (un distancia de recorrido es de 0 km si se devuelve la bicicleta a la misma estaci\'on de donde se la sac\'o).
      ...
      10 minutos hasta llegar a los 132 minutos, donde se agrup\'o a 3 valores muy extremos dentro de un solo intervalo. 
      ...
      \begin{myenv}{1}
        ...
        que presenta solo 3 recorridos con duraciones muy extremas.  

        Entonces, el nuevo total de recorridos con el que se trabaja es de 408 y este ser\'ia el histograma que representa la duraci\'on de los recorridos (menores a 132 minutos) tomando como unidad los 10 minutos para que as\'i la densidad representa la cantidad de recorridos.

        \begin{center}
          \includegraphics[scale=0.7]{HistDuracion.png}
        \end{center}

        Acompañando al histograma y manteniendo este total de 408 recorridos se presentan el pol\'igono de frecuencias y el pol\'igono acumulativo. 
